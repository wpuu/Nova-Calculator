...
public final class Preferences {
    ...
    public static class Gui {
        ...
        public enum Theme implements PreferenceEntry {
            ...
            premium_theme(R.string.cpp_theme_premium, R.style.Cpp_Theme_Premium, R.style.Cpp_Theme_Premium_Calculator, R.style.Cpp_Theme_Wizard, R.style.Cpp_Theme_Premium_Dialog, R.style.Cpp_Theme_Premium_Dialog_Alert),
            premium_neumorphism_theme(R.string.cpp_theme_premium_neumorphism, R.style.Cpp_Theme_PremiumNeumorphism, R.style.Cpp_Theme_PremiumNeumorphism_Calculator, R.style.Cpp_Theme_Wizard, R.style.Cpp_Theme_PremiumNeumorphism_Dialog, R.style.Cpp_Theme_PremiumNeumorphism_Dialog_Alert),
            premium_glass_theme(R.string.cpp_theme_premium_glass, R.style.Cpp_Theme_PremiumGlass, R.style.Cpp_Theme_PremiumGlass_Calculator, R.style.Cpp_Theme_Wizard, R.style.Cpp_Theme_PremiumGlass_Dialog, R.style.Cpp_Theme_PremiumGlass_Dialog_Alert),
            ios_theme(R.string.cpp_theme_ios, R.style.Cpp_Theme_IOS, R.style.Cpp_Theme_IOS_Calculator, R.style.Cpp_Theme_Wizard, R.style.Cpp_Theme_IOS_Dialog, R.style.Cpp_Theme_IOS_Dialog_Alert);
    ...
    static class Deleted {
        ...
        static final Preference<Gui.Theme> theme = StringPreference.ofEnum("org.solovyev.android.calculator.CalculatorActivity_calc_theme", Gui.Theme.premium_theme, Gui.Theme.class);
