...
public abstract class BaseActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final android.os.Handler dimHandler = new android.os.Handler(android.os.Looper.getMainLooper());
    ...
    private void resetDimTimer() {
        ...
        dimHandler.postDelayed(dimRunnable, 120_000); // 2 minutes
    }
